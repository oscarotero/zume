...
## [2.1.1] - 2019-02-06
### Added
- The `inline()` pipe in html is enabled by default in CLI mode
...
## [1.1.0] - 2018-06-26
### Added
- Plugin `markdown-it-html5-media` installed and enabled by default, allowing to insert `<video>` and `<audio>` elements.

## [1.0.0] - 2018-06-22
### Fixed
- Ensure `html.urls()` appends a `/` at the end of the urls.
...
### Changed
- Changed the signature of the plugin `html.navigation()`.
